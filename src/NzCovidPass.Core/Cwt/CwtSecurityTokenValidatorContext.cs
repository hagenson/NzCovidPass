...
namespace NzCovidPass.Core.Cwt
{
    ...
    public class CwtSecurityTokenValidatorContext : ValidationContext
    {
        ...
        public static FailureReason KeyIdValidationFailed =>
            new FailureReason(nameof(KeyIdValidationFailed), "Key ID (`kid`) parameter could not be found in CWT header.");

        /// <summary>
        /// Token identifier validation failure reason.
        /// </summary>
        public static FailureReason TokenIdValidationFailed =>
            new FailureReason(nameof(TokenIdValidationFailed), "Token ID (mapped `cti`) parameter could not be found in CWT payload.");
        ...
        public static FailureReason AlgorithmValidationFailed(IEnumerable<string> validAlgorithms) =>
            new FailureReason(nameof(AlgorithmValidationFailed),
        ...
        public static FailureReason IssuerValidationFailed(IEnumerable<string> validIssuers) =>
            new FailureReason(nameof(IssuerValidationFailed),
        ...
        public static FailureReason LifetimeValidationFailed =>
            new FailureReason(nameof(LifetimeValidationFailed), "Lifetime validation failed due to an inconsistency between not before parameter (`nbf`) and expiry parameter (`exp`).");

        /// <summary>
        /// Not before validation failure reason.
        /// </summary>
        public static FailureReason NotBeforeValidationFailed =>
            new FailureReason(nameof(NotBeforeValidationFailed), "Not before (`nbf`) parameter could not be found in CWT payload or has an unexpected value.");

        /// <summary>
        /// Expiry validation failure reason.
        /// </summary>
        public static FailureReason ExpiryValidationFailed =>
            new FailureReason(nameof(ExpiryValidationFailed), "Expiry (`exp`) parameter could not be found in CWT payload or has an unexpected value.");

        /// <summary>
        /// Failed verification key retrieval failure reason.
        /// </summary>
        public static FailureReason VerificationKeyRetrievalFailed =>
            new FailureReason(nameof(VerificationKeyRetrievalFailed),
        ...
        /// </summary>
        public static FailureReason SignatureValidationFailed => new FailureReason(nameof(SignatureValidationFailed), "Signature validation failed.");

        /// <summary>
        /// Credential validation failure reason.
        /// </summary>
        public static FailureReason CredentialValidationFailed => new FailureReason(nameof(CredentialValidationFailed), "Credential validation failed.");
        ...
        public static FailureReason CredentialContextValidationFailed(string baseContext, string credentialContext) =>
            new FailureReason(nameof(CredentialContextValidationFailed), $"Credential context is missing an expected value [Base context = {baseContext}, Credential context = {credentialContext}]");
        ...
        public static FailureReason CredentialTypeValidationFailed(string baseType, string credentialType) =>
            new FailureReason(nameof(CredentialTypeValidationFailed), $"Credential type is missing an expected value [Base type = {baseType}, Credential type = {credentialType}]");
    }
}
